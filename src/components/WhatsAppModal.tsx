      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-white/80 backdrop-blur-3xl border-2 border-pink-100 p-8 rounded-[48px] shadow-[0_40px_120px_rgba(242,27,127,0.15)] overflow-hidden"
          >
            {/* Pink Accent */}
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#f21b7f] via-pink-300 to-[#f21b7f]" />
            ...
            <div className="flex flex-col items-center text-center gap-6">
              <div className="w-28 h-28 flex items-center justify-center relative">
                <div className="absolute inset-0 bg-pink-100/50 blur-2xl rounded-full" />
                <img 
                  src="/logo2.png" 
                  alt="Logo Suene Nail" 
                  className="w-full h-full object-contain relative z-10 rounded-3xl drop-shadow-[0_0_20px_rgba(242,27,127,0.3)]"
              ...
              <div className="space-y-3">
                <h2 className="text-xl font-black text-slate-800 tracking-[0.1em] uppercase px-4">
                  CONFIRMAÇÃO <span className="text-pink-500">DIGITAL</span>
                </h2>
